...
# 				'scipy.misc', 'dynesty', 'scipy.optimize']

# MOCK_MODULES = ['numpy', 'scipy', 'matplotlib', 'matplotlib.pyplot', 'numpy.random', \
#  				'corner', 'getdist',\
#  				'scipy.special', 'mpl_toolkits.mplot3d', 'nestle', 'math','scipy',\
#  				'PIL', 'kerasnet', 'keras.models', 'keras.layers','scipy.integrate',\
#  				'keras.callbacks', 'keras.layers.normalization','keras',\
#  				'MCEvidence', 'emcee', 'scipy.integrate',\
#  				'scipy.interpolate', 'scipy.linalg', 'scipy.optimize',\
#  				'scipy.arange',\
#                 'numdifftools','pandas',\
#                 'dynesty', 'emcee', 'multiprocessing',\
#                 'numdifftools', 'seaborn', 'matplotlib.pylab', 'scipy.constants',\
#                 'scipy.array', 'Mock']
