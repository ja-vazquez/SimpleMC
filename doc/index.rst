=============================================================================
Welcome to SuperMC's documentation! (BETA version // not ready yet )
=============================================================================
...
* See the `requirements <intro.html#requirements>`_ .
* Or first steps in `Quickstart <intro.html#quick-start>`_.

SuperMC is a second version of  SimpleMC
-----------------------------------------
...
We have gathered great previous codes made by others and put them to work together in the cosmological context. In particular, we use the following codes:
   ...
   * `Dynesty <dynesty.readthedocs.io/>`_ developed by Josh Speagle. This contains Ellipsoidal Nested Sampling, Multinest, cubic bounds and ball bounds for nested sampling.
...
-----------------
   ...
   * Vazquez, JA., Gómez-Vargas, I., & Slosar, A. (2020). SuperMC: A package for cosmological parameter estimation and model comparison.
