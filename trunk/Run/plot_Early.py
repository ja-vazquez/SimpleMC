...
#print  'prefactor_2',T2.rde()

Ode_.setValue(0.2)
T3.updateParams([Ode_,Om_])
#print  'prefactor_3',T3.rde()


Ode_.setValue(0.3)
T4.updateParams([Ode_,Om_])
#print  'prefactor_4',T4.rde()
...
pylab.plot(zl,y1,'k-')
pylab.plot(zl,y4,'b-',label="Ode=0.3")
pylab.plot(zl,y3,'g-',label="Ode=0.2")
pylab.plot(zl,y2,'r-',label="Ode=0.1") 
