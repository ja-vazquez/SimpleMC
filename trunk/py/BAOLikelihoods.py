...
class ACPNS_1(TabulatedBAOLikelihood):
    def __init__(self):
        obh2=0.022; Om=0.31; h=0.676; mnu=0.06
        fidTheory=LCDMCosmology(obh2, Om, h, mnu)
        TabulatedBAOLikelihood.__init__(self,"ACPNS_1",'data/aratdatacombrecACPNScombaccarec15st01covchi.dat',
				   2, fidTheory, 0.39 )

class ACPNS_3(TabulatedBAOLikelihood):
    def __init__(self):
	obh2=0.022; Om=0.31; h=0.676; mnu=0.06
	fidTheory=LCDMCosmology(obh2, Om, h, mnu)
	TabulatedBAOLikelihood.__init__(self,"ACPNS_3",'data/aratdatacombrecACPNScombaccarec35st01covchi.dat',
				   2, fidTheory, 0.6 )

class CombBAOzb1(TabulatedBAOLikelihood):
    def __init__(self):
	obh2=0.022; Om=0.31; h=0.676; mnu=0.06
 	fidTheory=LCDMCosmology(obh2, Om, h, mnu)
	TabulatedBAOLikelihood.__init__(self,"CombBAOzb1",'data/combxiFBBAOlikgrid_zb1.dat',
				   -2, fidTheory, 0.38, order_aper_apar =False )	

class CombBAOzb2(TabulatedBAOLikelihood):
    def __init__(self):
        obh2=0.022; Om=0.31; h=0.676; mnu=0.06
        fidTheory=LCDMCosmology(obh2, Om, h, mnu)
        TabulatedBAOLikelihood.__init__(self,"CombBAOzb12",'data/combxiFBBAOlikgrid_zb2.dat',
                                   -2, fidTheory, 0.51, order_aper_apar =False )

class CombBAOzb3(TabulatedBAOLikelihood):
    def __init__(self):
        obh2=0.022; Om=0.31; h=0.676; mnu=0.06
        fidTheory=LCDMCosmology(obh2, Om, h, mnu)
        TabulatedBAOLikelihood.__init__(self,"CombBAOzb3",'data/combxiFBBAOlikgrid_zb3.dat',
                                   -2, fidTheory, 0.61, order_aper_apar =False )
