...
outputfile.write(r"o$w_0w_a$CDM & Planck + CMASS-iso + LOWZ & %.4f (%i) & %.3f (%i) & %.1f (%i) & %+.4f (%i) & %.2f (%i) & %.2f (%i) \\" %(omh2_avg,np.int(10000*omh2_std),om_avg,np.int(1000*om_std),h0_avg,np.int(10*h0_std),ok_avg,np.int(10000*ok_std),w_avg,np.int(100*w_std),wa_avg,np.int(100*wa_std)) +'\n')
...
outputfile.write(r"o$w_0w_a$CDM & Planck + CMASS + LOWZ & %.4f (%i) & %.3f (%i) & %.1f (%i) & %+.4f (%i) & %.2f (%i) & %.2f (%i) \\" %(omh2_avg,np.int(10000*omh2_std),om_avg,np.int(1000*om_std),h0_avg,np.int(10*h0_std),ok_avg,np.int(10000*ok_std),w_avg,np.int(100*w_std),wa_avg,np.int(100*wa_std)) +'\n')
...
outputfile.write(r"o$w_0w_a$CDM & Planck + BAO & %.4f (%i) & %.3f (%i) & %.1f (%i) & %+.4f (%i) & %.2f (%i) & %.2f (%i) \\" %(omh2_avg,np.int(10000*omh2_std),om_avg,np.int(1000*om_std),h0_avg,np.int(10*h0_std),ok_avg,np.int(10000*ok_std),w_avg,np.int(100*w_std),wa_avg,np.int(100*wa_std)) +'\n')
...
outputfile.write(r"o$w_0w_a$CDM & Planck + CMASS + LOWZ + SN & %.4f (%i) & %.3f (%i) & %.1f (%i) & %+.4f (%i) & %.2f (%i) & %.2f (%i) \\" %(omh2_avg,np.int(10000*omh2_std),om_avg,np.int(1000*om_std),h0_avg,np.int(10*h0_std),ok_avg,np.int(10000*ok_std),w_avg,np.int(100*w_std),wa_avg,np.int(100*wa_std)) +'\n')
...
outputfile.write(r"o$w_0w_a$CDM & Planck + BAO + SN & %.4f (%i) & %.3f (%i) & %.1f (%i) & %+.4f (%i) & %.2f (%i) & %.2f (%i) \\" %(omh2_avg,np.int(10000*omh2_std),om_avg,np.int(1000*om_std),h0_avg,np.int(10*h0_std),ok_avg,np.int(10000*ok_std),w_avg,np.int(100*w_std),wa_avg,np.int(100*wa_std)) +'\n')
...
outputfile.write(r"o$w_0w_a$CDM & WMAP + BAO + SN & %.4f (%i) & %.3f (%i) & %.1f (%i) & %+.4f (%i) & %.2f (%i) & %.2f (%i) \\" %(omh2_avg,np.int(10000*omh2_std),om_avg,np.int(1000*om_std),h0_avg,np.int(10*h0_std),ok_avg,np.int(10000*ok_std),w_avg,np.int(100*w_std),wa_avg,np.int(100*wa_std)) +'\n')
...
outputfile.write(r"o$w_0w_a$CDM & \textit{e}WMAP + BAO + SN & %.4f (%i) & %.3f (%i) & %.1f (%i) & %+.4f (%i) & %.2f (%i) & %.2f (%i) \\" %(omh2_avg,np.int(10000*omh2_std),om_avg,np.int(1000*om_std),h0_avg,np.int(10*h0_std),ok_avg,np.int(10000*ok_std),w_avg,np.int(100*w_std),wa_avg,np.int(100*wa_std)) +'\n')
outputfile.write(r"\hline"+'\n')
